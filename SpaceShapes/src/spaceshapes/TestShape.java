...
public class TestShape {
	...
	public void testShapeMoveWithBounceOffBottomAndRight() {
		RectangleShape shape = new RectangleShape(112, 110, 15, 15);
		shape.paint(_painter);
		shape.move(125, 135);
		shape.paint(_painter);
		shape.move(125, 135);
		...
		assertEquals("(rectangle 112,110,25,35)(rectangle 100,100,25,35)"
				+ "(rectangle 85,85,25,35)", _painter.toString());
	}
}
